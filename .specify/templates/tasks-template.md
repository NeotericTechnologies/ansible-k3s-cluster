...
- [ ] T004 Configure token-optimized execution defaults (`rtk`, silent output mode, diff-only edit workflow)
...
- [ ] T011 Establish evidence ledger for repository-grounded facts and assumptions
- [ ] T012 Add validation task to reject unsupported claims in generated docs/plans
...
- [ ] TXXX Verify evidence citations and assumption tracking are complete
- [ ] TXXX Verify token-optimization and silent-output policy compliance in generated artifacts
