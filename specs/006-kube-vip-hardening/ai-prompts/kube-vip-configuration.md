...
- Primary - Optionally configure DHCP for the Kube-VIP load balancer(s).
  - References:
...
The references provided for each feature are provided simply as a starting point for research and implementation details.  The source code would be the definitive source of information with respect to each feature.  Ensure you do your research.
